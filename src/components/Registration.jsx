          ...
          <div className="modal-dialog ">
            <div className="modal-content bg-black">
             ...
             New Message to Confirm.
              ...
              <Link to="https://chat.whatsapp.com/FAAPKqm0pfg25Q5hZUIYaM" target="_blank" className='btn bg-succss text-white p-3 w-100 d-block' style={{"backgroundColor":"green"}}>Confirm Registration</Link>
               </div>
            </div>
          </div>
        </div>
